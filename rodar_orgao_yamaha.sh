#!/usr/bin/env bash
# =============================================================================
# rodar_orgao_yamaha.sh — Execução completa do projeto "Hinos em Orgão Yamaha"
#
# Uso:
#   ./rodar_orgao_yamaha.sh              # processa tudo pendente + coletâneas
#   ./rodar_orgao_yamaha.sh --forcar     # força regeração de coletâneas já existentes
# =============================================================================
...
echo "============================================================"
echo "  Projeto: Hinos em Orgão Yamaha"
